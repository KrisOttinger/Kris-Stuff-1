...
//Function Prototypes
int pointSystem1(int,int,int,int,int,int,int,int,int,int,int,int,int,int []);
...
//**********************************************BOT Point System****************************************
    plyrT++;
        if(plyrT==2&&plyr3M>=1){    //Bot 1 point system
            p2A=pointSystem1(plyr2H1,plyr2S1,plyr2S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 1 points
            p2B=pointSystem1(plyr2H2,plyr2S1,plyr2S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry);
            p2=0;
            if(p2A==0&&p2B==0)p2=0;
        ...
        if(plyrT==3&&plyr4M>=1){    //Bot 2 point system
            p3A=pointSystem1(plyr3H1,plyr3S1,plyr3S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 1 points
            p3B=pointSystem1(plyr3H2,plyr3S1,plyr3S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry);
            p3=0;
            if(p3A==0&&p3B==0)p3=0;
        ...
        if(plyrT==4&&plyr4M>=1){    //Bot 3 point system
            p4A=pointSystem1(plyr4H1,plyr4S1,plyr4S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 1 points
            p4B=pointSystem1(plyr4H2,plyr4S1,plyr4S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry);
            p4=0;
            if(p4A==0&&p4B==0)p4=0;
        ...
        if(plyrT==5&&plyr5M>=1){    //Bot 4 point system
            p5A=pointSystem1(plyr5H1,plyr5S1,plyr5S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 1 points
            p5B=pointSystem1(plyr5H2,plyr5S1,plyr5S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry);
            p5=0;
            if(p5A==0&&p5B==0)p5=0;
    ...
    if(plyrT==6&&plyr1M>=1){   //Allow player to get points as long as they don't fold and have money
        p1A=pointSystem1(plyr1H1,plyr1S1,plyr1S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 1 points
        p1B=pointSystem1(plyr1H2,plyr1S2,plyr1S2,tblH1,tblH2,tblH3,tblH4,tblH5,tblS1,tblS2,tblS3,tblS4,tblS5,arry); //Player hand 2 points
        p1=0;
        if(p1A==p1B==0)p1=0;
    ...
    //**************************Win or Lose Round********************************************
        ...
        else cout<<"Tie, sorry! :"<<p1<<p2<<p3<<p4<<p5<<" = card points"<<endl;
              
            cout<<""<<endl;
            cout<<"next round! ready? y/n :";
            cin>>next; 
            if(next=='n')exit(EXIT_FAILURE);
            else cout<<"";
...
int pointSystem1(int hand,int suit1,int suit2,int tH1,int tH2,int tH3,//Scoring System.. scroll down at your own risk! its ugly!
    ...
    //int arry[5]={tH1,tH2,tH3,tH4,tH5}; //Table card array and arrange from 2-14;
        p1=0;
        p=0;
        str=0;
...
//*****************************Which is larger and return*****************************************
    if(p>tw&&p>fl&&p>str&&p>tr)p1=p;
    else if(tw>p&&tw>fl&&tw>str&&tw>tr)p1=tw;
    else if (fl>p&&fl>tw&&fl>str&&fl>tr)p1=fl;
    else if (str>p&&str>tw&&str>fl&&str>tr)p1=str;
    else if (tr>p&&tr>tw&&tr>fl&&tr>str)p1=3;
    else p1=0;
